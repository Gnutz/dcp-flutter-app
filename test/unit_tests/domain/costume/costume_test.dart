...
main() {
  test(
      "setting the status to something else than InStorage should also set stotageLocation to null",
      () {
    //arrange
  ...
  test(
      "setting valid storage location with both a main and sublocation sets the status to in storage",
      () {
    //arrange
