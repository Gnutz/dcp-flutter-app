...
class _$_SearchState implements _SearchState {
  ...
  @override
  String toString() {
    return 'SearchState(production: $production, fashion: $fashion, category: $category, timePeriod: $timePeriod, themes: $themes, colors: $colors)';
  }
...
abstract class _SearchState implements SearchState {
  const factory _SearchState(
      ...
      String? timePeriod,
      List<String>? themes,
      List<String>? colors}) = _$_SearchState;
